export const habilidadesEspeciaisData = {
    racas: {
        ...
        elfo: ["Imunidade a Sono", "+2 vs Encantamentos", "Visão na Penumbra", "+1 Ouvir*", "+1 Procurar*","+1 Observar*", "Usar Armas Comum: Espada Longa","Usar Armas Comum: Sabre","Usar Armas Comum: Arco Longo", "Usar Armas Comum: Arco Longo Composto","Usar Armas Comum: Arco Curto","Usar Armas Comum: Arco Curto Composto",],
        ...
        halfling: ["+1 em Resistências*", "+2 vs Medo", "+1 Ataque (Arremesso)*", "+1 BA tamanho", "+4 esconder-se*", "armas menores", "lev e carregar peso 3/4", "+2 Escalar", "+2 Saltar*", "+2 Furtividade*", "+2 res vs medo", "+2 Ouvir*"],
