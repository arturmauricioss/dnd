export const habilidadesEspeciaisData = {
    racas: {
        ...
        halfling: ["+1 em Todas RES*", "+1 Ataque (Arremesso)*", "+1 CA Tamanho*","+1 BA tamanho", "+4 esconder-se*", "armas menores", "lev e carregar peso 3/4", "+2 Escalar", "+2 Saltar*", "+2 Furtividade*", "+2 RES vs medo", "+2 Ouvir*"],
