...
const heroisIniciais: Heroi[] = [
  { id: '1', nome: 'Aragorn', level: 5, imagem: '/lotr/aragorn.jpg', status: 'alive' },
  { id: '2', nome: 'Gandalf', level: 12, imagem: '/lotr/gandalf.jpeg', status: 'alive' },
  { id: '3', nome: 'Legolas', level: 8, imagem: '/lotr/legolas.jpg', status: 'alive' },
  { id: '4', nome: 'Boromir', level: 7, imagem: '/lotr/aragorn.jpg', status: 'dead' },
  { id: '5', nome: 'Gimli', level: 6, imagem: '/lotr/aragorn.jpg', status: 'dead' },
]
