...
export const todasArmas = {
  ...
  "machado-guerra-anao": { nome: "Machado de guerra anão", categoria: "exotica", subcategoria: "uma_mao", custo: 3000, dano: "1d10", critico: "x3", alcance: "-", peso: 4, tipo1: "cortante", tipo2: "" },
  ...
  "shuriken": { nome: "Shuriken (5)", categoria: "exotica", subcategoria: "distancia", custo: 100, dano: "1d2", critico: "x2", alcance: "3m", peso: 0.25, tipo1: "perfurante", tipo2: ""  }
};
...
function normalizarArma(id, arma) {
  ...
  return { id, ...arma, tipo, icon, tipoLoja }
}
