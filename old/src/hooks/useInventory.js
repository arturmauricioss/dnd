...
import { getItemPorId, getItemAjustadoPorTamanho, getItemPorId as getItemPorIdEquip } from '@rules/carga'
import { getCapacidade, getCapacidadeMontaria, tabelaCarga, getPesoTotalEquipamentos } from '@rules/carga'
