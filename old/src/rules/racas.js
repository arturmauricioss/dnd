import { racas, bonusRacialAtributos, fisicoPorRaca, fisicoGeral, idadePorRaca, tamanhoPorRaca } from '@data/racasData'
import { deusesRaciais } from '@data/deusesRaciaisData'
import { getDeusPorId } from '@rules/divindades'
