...
import { converterParaPO } from '@data/dinheiroData'
import { getItemPorId } from '@rules/equipamentos'
import { getItemAjustadoPorTamanho, getPesoItem, getCapacidade, getCapacidadeMontaria, tabelaCarga, getPesoTotalEquipamentos } from '@rules/carga'
import { getTamanhoPorRaca, getBonusRacial } from '@rules/racas'
import { getDinheiroInicial } from '@data/classesData'
import { montarias, transporte } from '@data/equipamentos/montariasData'
...
const renderSecao = (titulo, itensLista, tipo) => {
  ...
  return (
    <div className="inventario-container">
      ...
      <Navigation prev="/personagem/combat" next="/loja"/>
    </div>
  )
}