...
import { todosItens } from '@rules/equipamentos'
import { converterParaCobre } from '@data/dinheiroData'
import { getDinheiroInicial } from '@data/classesData'
import { getItemAjustadoPorTamanho } from '@rules/carga'
import { lojas, itensPorLoja } from '@data/lojasData'
