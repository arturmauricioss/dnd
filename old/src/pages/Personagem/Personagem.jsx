...
import { classes, niveis } from '@data/classesData'
import { racas, sexos } from '@data/racasData'
import { getFisicoSugerido, getIdadeSugerida, getTamanhoPorRaca } from '@rules/racas'
import { filtrarDeuses, filtrarAlinhamentosPorClasse } from '@rules/divindades'
import { alinhamentoValidoParaClasse } from '@data/alinhamentosData';
