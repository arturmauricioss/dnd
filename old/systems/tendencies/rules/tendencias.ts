import { tendenciasPermitidasPorClasse } from '@systems/tendencies/data/tendenciasClassesData'
import { divindades, deusesRaciais, deusesPorClasse, Divindade } from '@systems/tendencies/data/tendenciasData'
